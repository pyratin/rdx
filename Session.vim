...
silent! normal! zE
let &fdl = &fdl
let s:l = 41 - ((31 * winheight(0) + 20) / 40)
...
normal! 021|
tabnext
edit source/client/store/post/index.js
argglobal
...
silent! normal! zE
let &fdl = &fdl
let s:l = 124 - ((36 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 124
...
argglobal
balt source/client/Route/Post/EntityCollection/index.js
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
silent! normal! zE
let &fdl = &fdl
let s:l = 49 - ((31 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 49
...
badd +49 source/client/Route/Post/EntityCollection/index.js
